local Categories = {"Favourites", "Chips, Gates", "Visuals", "Detection", "Input, Output", "Other", "Tools", "Options"}
...
local function WireTab()
    ...
    function spawnmenu.AddToolMenuOption(tab, category, ...)
        if tab == "Main" and string.lower(string.Left(category, 4)) == "wire" then
            tab = "Wire"
        end
